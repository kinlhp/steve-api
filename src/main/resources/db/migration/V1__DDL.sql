...
CREATE TABLE `condicao_pagamento` (
  ...
  `usuario_alteracao` smallint(5) unsigned DEFAULT NULL,
  ...
  KEY `FK_condicao_pagamento_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_condicao_pagamento_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `conta_pagar` (
  ...
  KEY `FK_conta_pagar_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_conta_pagar_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `conta_receber` (
  ...
  KEY `FK_conta_receber_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_conta_receber_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `credencial` (
  ...
  KEY `FK_credencial_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_credencial_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `email` (
  ...
  KEY `FK_email_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_email_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `endereco` (
  ...
  KEY `FK_endereco_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_endereco_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `forma_pagamento` (
  ...
  KEY `FK_forma_pagamento_usuario_alteracao_INDEX` (`usuario_alteracao`),
  KEY `FK_forma_pagamento_usuario_criacao_INDEX` (`usuario_criacao`),
  CONSTRAINT `FK_forma_pagamento_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `item_ordem_servico` (
  ...
  KEY `FK_item_ordem_servico_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_item_ordem_servico_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `ordem` (
  ...
  KEY `FK_ordem_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_ordem_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `pessoa` (
  ...
  KEY `FK_pessoa_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_pessoa_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `servico` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `descricao_UNIQUE` (`descricao`),
  KEY `FK_servico_usuario_alteracao_INDEX` (`usuario_alteracao`),
  KEY `FK_servico_usuario_criacao_INDEX` (`usuario_criacao`),
  CONSTRAINT `FK_servico_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `telefone` (
  ...
  KEY `FK_telefone_usuario_alteracao_INDEX` (`usuario_alteracao`),
  ...
  CONSTRAINT `FK_telefone_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `uf` (
  ...
  KEY `FK_uf_usuario_alteracao_INDEX` (`usuario_alteracao`),
  KEY `FK_uf_usuario_criacao_INDEX` (`usuario_criacao`),
  CONSTRAINT `FK_uf_usuario_alteracao` FOREIGN KEY (`usuario_alteracao`) REFERENCES `credencial` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Dumping events for database 'steve'
--

--
-- Dumping routines for database 'steve'
--
...
-- Dump completed on 2017-10-26 21:03:34
